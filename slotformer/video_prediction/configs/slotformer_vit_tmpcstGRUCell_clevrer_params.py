...
class SlotFormerParams(BaseParams):
    ...
    slots_root = './data/CLEVRER/vit_tmpcstGRUcell_clevrer_slots.pkl'
    ...
    dec_dict = dict(
        ...
        img_dec_channels=(128, 64, 64, 64, 64),
        img_dec_resolution=(8, 8),
        img_dec_ks=5,
        img_dec_norm='',
        dec_ckp_path='pretrained/stosavi_vit_tmpcstGRUcell_clevrer_params/model_12.pth',
    )
